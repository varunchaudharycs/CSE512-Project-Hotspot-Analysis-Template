...
libraryDependencies ++= Seq(
  "org.apache.spark" %% "spark-core" % "2.2.0" % "provided", // TODO default- provided, to run on IDE- compile
  "org.apache.spark" %% "spark-sql" % "2.2.0" % "provided", // TODO default- provided, to run on IDE- compile
